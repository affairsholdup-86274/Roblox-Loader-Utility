...
XCutors is a collection of Windows desktop tools for running Lua scripts in Roblox games.

### Which executors are included?

It includes Volt, Synapse Z, Potassium, Wave, and a universal loader.

### Is it safe to use?

XCutors is designed for stability and security, but always use third-party tools responsibly.

### How do I update the executors?

Check the GitHub repository for updates or use the built-in update feature in the loader.

### Does it work on all Roblox games?

Most executors support a wide range of games, but compatibility may vary.

### Can I add custom scripts?

Yes, the universal loader allows you to load and manage custom Lua scripts.

### What are the system requirements?

Windows 10 or later, with .NET Framework or similar dependencies as specified.

### Is there technical support available?

You can report issues on the GitHub page or check the documentation for help.
